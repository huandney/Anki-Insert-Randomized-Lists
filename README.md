...
The above JS script may change over time (as a result of updates, etc.). Make sure to always use the code in [`shuffle-template.html`](https://raw.githubusercontent.com/huandney/Anki-Insert-Randomized-Lists/improve-repo-organization/src/card/shuffle-template.html) for the most up-to-date version of the script.
