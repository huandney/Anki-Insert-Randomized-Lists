...
* Copy and paste the content of [`shuffle-template.html`](https://github.com/huandney/Anki-Insert-Randomized-Lists/blob/improve-repo-organization/src/card/shuffle-template.html) into the front and back template of your cards.
