...
* Copy and paste the content of [`randomized-lists-template.html`](https://raw.githubusercontent.com/huandney/Anki-Insert-Randomized-Lists/main/src/card/randomized-lists-template.html) into the front and back template of your cards.
...
The above JS script may change over time (as a result of updates, etc.). Make sure to always use the code in [`randomized-lists-template.html`](https://github.com/huandney/Anki-Insert-Randomized-Lists/blob/main/src/card/randomized-lists-template.html) for the most up-to-date version of the script.
...
The randomization [script](https://github.com/huandney/Anki-Insert-Randomized-Lists/blob/main/src/card/randomized-lists-template.html) and the add-on have been tested across various Anki platforms and versions to ensure maximum compatibility. Here are the details:
